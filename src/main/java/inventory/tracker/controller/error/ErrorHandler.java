package inventory.tracker.controller.error;
...
public class ErrorHandler {
	...
	public ExceptionMessage handleNoSuchElementException(NoSuchElementException ex, WebRequest webRequest) {
		return buildExecptionMessage(ex, HttpStatus.NOT_FOUND, webRequest, LogStatus.MESSAGE_ONLY);
	}

	private ExceptionMessage buildExecptionMessage(NoSuchElementException ex, HttpStatus status,
